...
function createProjectNodeRendezvousService(options = {}) {
  ...
  function announcePresence(body = {}, meta = {}) {
    ...
    const row = {
      ...
      publicEndpoint,
      signalEndpoint: normalizeString(body.signalEndpoint || publicEndpoint),
      turnEndpoint: normalizeString(body.turnEndpoint || body.publicNode?.turnEndpoint || ''),
      relayEndpoint: normalizeString(body.relayEndpoint || body.publicNode?.relayEndpoint || publicEndpoint),
      publicNode: body.publicNode && typeof body.publicNode === 'object' ? { ...body.publicNode } : null,
